...
{
    /// <summary>
    /// This represents an emergency contact person.
    /// </summary>
    public class SOSContactStore : IListableDataStore<Contact>
    {
        /// <summary>
        ...
        public async Task AddAsync(Contact data)
        {
            ...
            Application.Current.Properties["SOS_ContactList"] = contactsJson;
        ...
        public async Task ReplaceAsync(ObservableCollection<Contact> data)
        {
            ...
            else
            {
                ...
                Application.Current.Properties["SOS_ContactList"] = contacts;
                await Application.Current.SavePropertiesAsync();
            }
        }
        ...
        public Task Clear()
        {
            return Task.Run(() =>
            {
                Application.Current.Properties["SOS_ContactList"] = null;
            });
        }
        ...
        public Task<Contact> GetAsync(string id)
        {
            return Task.Run(() =>
            {
                var data = (string)Application.Current.Properties["SOS_ContactList"];
